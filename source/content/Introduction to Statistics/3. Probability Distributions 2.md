...
Suppose $Y = aX + b$, then $Var(Y) = a^2 \cdot Var(X)$
...
\end{align}
$$
This is very useful; suppose $Var(X) = 25$, and $Y = -X + 5000000$, then $Var(Y) = 1 \cdot Var(X) = 25$, and the standard deviation, $\sigma = 5$.
